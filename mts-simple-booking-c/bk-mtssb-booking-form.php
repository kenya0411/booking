									...
									if (0 < $this->clcols['vehicle']) : ?>
										...
										<td>
											...
											foreach($vehicleTimeTableList as $key => $val){
												?>
												<input type='radio' name="booking[client][vehicle]" value="<?php echo $vehicleTimeTable[$val] ?>" id="vehicle<?php echo $val ?>" data-name="vehicleCheck" data-count="<?php echo $key ?>" data-check="<?php echo date('H', $this->thetime)?>" >
												<label for="vehicle<?php echo $key ?>"><?php echo $vehicleTimeTable[$val] ?></label>
											<?php } ?>
